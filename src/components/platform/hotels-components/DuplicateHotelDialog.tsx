...
export function DuplicateHotelDialog({
  hotel,
  open,
  onOpenChange,
  onChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-md'>
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new property based on "{hotel.name}". Unique fields must be
            updated.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className='space-y-4 py-4'>
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={(e) =>
                onChange({ ...hotel, ownerEmail: e.target.value })
              }
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={(e) =>
                onChange({ ...hotel, ownerName: e.target.value })
              }
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={(e) => onChange({ ...hotel, password: e.target.value })}
            />
          </div>
          <div className='space-y-2'>
            ...
            <Select
              value={hotel.plan ?? ""}
              onValueChange={(v) => onChange({ ...hotel, plan: v })}
            >
