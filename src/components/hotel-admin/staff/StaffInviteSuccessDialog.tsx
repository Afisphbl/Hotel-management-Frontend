...
interface StaffInviteSuccessDialogProps {
  result: InviteResult | null;
  onClose: () => void;
}

export function StaffInviteSuccessDialog({ result, onClose }: StaffInviteSuccessDialogProps) {
  return (
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <Button variant="outline" size="sm" className="shrink-0"
                    onClick={() => { navigator.clipboard.writeText(result.tempPassword!); toast.success('Password copied'); }}>
                    Copy
                  </Button>
                </div>
