    ...
    <div className='space-y-6'>
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
        <div>
          ...
          <p className='text-sm text-muted-foreground mt-1'>
            Record of critical platform actions.
          </p>
        </div>
        <Button
          variant='outline'
          className='w-full md:w-auto bg-white border-none shadow-sm gap-2'
        >
      ...
      <div className='flex flex-col lg:flex-row lg:items-center gap-4'>
        ...
        <div className='flex gap-2 w-full lg:w-auto'>
          <Button
            variant='outline'
            className='flex-1 lg:flex-none bg-white border-none shadow-sm gap-2 whitespace-nowrap overflow-hidden'
          >
            <Calendar className='w-4 h-4 hidden sm:block' /> Range
          </Button>
          <Button
            variant='outline'
            className='lg:flex-none bg-white border-none shadow-sm gap-2'
          >
            ...
            <Table>
              <TableHeader>
                <TableRow className='bg-slate-50/50'>
                  ...
                  <TableHead className='hidden xl:table-cell pr-6 min-w-[120px]'>
                    IP
                  </TableHead>
                </TableRow>
              </TableHeader>
                  ...
                  <TableRow>
                    <TableCell colSpan={6} className='py-12 text-center'>
                      ...
                      <p className='text-xs text-slate-400'>
                        All platform operations will be logged here.
                      </p>
                    </TableCell>
                  </TableRow>
                ) : (
                  logs.map((log: any) => (
                    ...
                    >
                      ...
                      <TableCell className='hidden md:table-cell'>
                        <Badge
                          variant='outline'
                          className='text-[10px] font-bold uppercase border-slate-200 whitespace-nowrap'
                        >
                          {log.action}
                        </Badge>
                      </TableCell>
