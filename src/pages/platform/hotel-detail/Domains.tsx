    ...
    <div className='space-y-6'>
        ...
        <CardHeader>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <CardDescription>
                Managed internal routing for this tenant environment.
              </CardDescription>
            </div>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='p-4 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-500 flex gap-2'>
            ...
            <div>
              ...
              Changing the subdomain will immediately break all existing staff
              bookmarks and API integrations using the old URL. Subdomain
              modification requires manual database migration and routing
              updates by the platform engineering team.
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardHeader>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <CardDescription>
                Assign a branded domain for client usage.
              </CardDescription>
            </div>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-2 text-xs'>
                      ...
                      <span className='text-muted-foreground uppercase font-bold tracking-tighter text-[9px]'>
                        Expires June 2024
                      </span>
                    </div>
                  </div>
                  ...
                  {domains.dnsRecords.map((record: any, i: number) => (
                    ...
                    >
                      <div className='flex flex-wrap items-center gap-2 sm:gap-3'>
                        <Badge
                          variant='outline'
                          className='bg-slate-100 font-bold border-none px-1 h-5'
                        >
                          {record.type}
                        </Badge>
                      ...
                      <Button
                        variant='ghost'
                        size='icon'
                        className='h-6 w-6 self-end sm:self-auto shrink-0'
      ...
      <Card className='shadow-sm border-none bg-white'>
        <CardHeader>
          ...
          <CardDescription>
            Direct links to all operational portals for this property.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            {[
              {
                ...
                url: domains.urls?.dashboard,
                icon: Layout,
              },
              {
                label: "Staff Login",
                url: domains.urls?.staffLogin,
                icon: Monitor,
              },
              {
                label: "Guest Portal",
                url: domains.urls?.guestPortal,
                icon: Globe,
              },
              {
                label: "Booking Engine",
                url: domains.urls?.bookingEngine,
                icon: ShieldCheck,
              },
            ].map((point, i) => (
              <div
                key={i}
                className='p-4 bg-[#F8F7F4] rounded-xl flex items-center justify-between group overflow-hidden'
              >
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xs font-mono font-medium truncate max-w-[200px]'>
                      {point.url}
                    </p>
                  </div>
                </div>
                <div className='flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity'>
                  <Button
                    ...
                    size='icon'
                    className='h-8 w-8'
                    onClick={() => copyToClipboard(point.url)}
                  >
