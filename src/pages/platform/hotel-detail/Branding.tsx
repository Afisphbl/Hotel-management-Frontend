    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
      ...
      <div className='space-y-6'>
        <Card className='shadow-sm border-none bg-white'>
          <CardHeader>
            <CardTitle className='font-serif text-xl flex flex-col gap-2'>
              <input
                type='file'
                ref={fileInputRef}
                className='hidden'
                  ...
                  <div className='flex gap-2'>
                    <div className='relative'>
                      <div
                        ...
                        onClick={() =>
                          document
                            .getElementById("primary-color-picker")
                            ?.click()
                        }
                      />
                      <input
                  ...
                  <div className='flex gap-2'>
                    <div className='relative'>
                      <div
                        ...
                        onClick={() =>
                          document
                            .getElementById("accent-color-picker")
                            ?.click()
                        }
                      />
                      <input
      ...
      <div className='space-y-4'>
        ...
        >
          ...
          <div className='absolute inset-0 bg-[#F8F7F4] flex'>
            ...
            <div className='flex-1 flex flex-col min-w-0'>
              {/* Header */}
              <div
                className='h-14 bg-white border-b px-4 flex items-center justify-between'
                style={{ borderTop: `3px solid ${formData.accentColor}` }}
              >
        ...
        <p className='text-center text-xs text-muted-foreground italic'>
          This is a simulated preview of the tenant's actual operational
          environment.
        </p>
      </div>
    </div>
