...
import { usePlatformHotel, useUpdatePlatformHotel } from '@/hooks/usePlatformData';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 bg-[#0F1B2D] text-white rounded-xl flex items-center justify-between shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-300 uppercase font-bold tracking-widest">Super Admin Capability</p>
          </div>
        </div>
        <Button 
          variant="secondary" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="shadow-sm border-none bg-white">
          <CardHeader>
            ...
            <CardDescription>Tenant-specific regional settings.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
      ...
      <Card className="shadow-sm border-none bg-white border-red-100 bg-red-50/10">
        <CardHeader>
          <CardTitle className="font-serif text-xl text-red-800">Tenant Lifecycle Management</CardTitle>
          <CardDescription>Controlled destruction and archival of this tenant workspace.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 border border-red-200 rounded-xl bg-white">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-amber-50 rounded text-amber-600"><AlertTriangle className="w-5 h-5" /></div>
              <div>
                <p className="font-bold text-slate-900">Suspend Access</p>
                <p className="text-xs text-muted-foreground">Immediately revoke all user access while preserving data.</p>
              </div>
            </div>
            <Button variant="outline" className="border-amber-200 text-amber-700 hover:bg-amber-50">Suspend</Button>
          </div>
          
          <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl bg-white">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-slate-50 rounded text-slate-600"><Archive className="w-5 h-5" /></div>
              <div>
                <p className="font-bold text-slate-900">Archive Tenant</p>
                <p className="text-xs text-muted-foreground">Mark as inactive and offboard. Data retained for 90 days.</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 border border-red-200 rounded-xl bg-red-50">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-red-100 rounded text-red-600"><Trash2 className="w-5 h-5" /></div>
              <div>
                <p className="font-bold text-red-900">Permanent Termination</p>
                <p className="text-xs text-red-700">Wipe all databases, assets, and configurations permanently.</p>
              </div>
            </div>
