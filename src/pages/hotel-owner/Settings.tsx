...
export function OwnerSettings() {
  ...
  const save = async (endpoint: string, body: any) => {
    ...
    try {
      await api.patch(
        `hotel/owner/hotels/${selectedHotelId}/${endpoint}`,
        body,
      );
      toast.success("Saved");
    } catch (e: any) {
  ...
  const uploadLogo = async () => {
    if (!logoFile || !selectedHotelId) return;
    ...
    <div className='space-y-8 pb-10'>
      <div>
        ...
        <p className='text-sm text-muted-foreground'>
          Manage your account and hotel configuration
        </p>
      </div>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                ...
                <div className='space-y-1.5'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setHotelInfo({ ...hotelInfo, timezone: e.target.value })
                    }
                ...
                <div className='space-y-1.5'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setHotelInfo({ ...hotelInfo, currency: e.target.value })
                    }
